...
export default function Features() {
  return (
    <section id="features" className="py-24 bg-white dark:bg-slate-900 relative" aria-label="Features section">
          ...
          {features.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                dark:bg-slate-900/80 backdrop-blur hover:border-blue-500/40 hover:shadow-2xl transition-all duration-300"
              >
