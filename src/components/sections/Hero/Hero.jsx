...
export default function Hero() {
  return (
    <Section
      ...
      className="relative min-h-screen flex items-center overflow-visible bg-gradient-to-b from-white via-slate-50 to-white dark:from-slate-950 dark:via-slate-900 dark:to-slate-950"
    >
      {/* background orbs */}
      ...
      <div className="grid md:grid-cols-2 gap-14 items-center w-full">
        ...
        >
          ...
          <Badge className="bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300 border-blue-200 dark:border-blue-800">
          ...
          <p className="text-lg md:text-xl text-slate-600 dark:text-slate-300 max-w-xl leading-relaxed">
            Practice real interview patterns, company-specific questions,
            and AI-driven mock tests designed to simulate actual hiring pipelines.
          </p>
